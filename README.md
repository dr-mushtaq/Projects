...
|[**🌐14-POS Tagging for Multiple Languages**](https://mushtaqmsit.substack.com/p/building-a-multilingual-pos-tagging) |This project is a FastAPI web application that performs Part-of-Speech (POS) tagging using Stanza, a neural NLP library developed by Stanford. It supports POS tagging for various Indian languages, including English, Hindi, Marathi, Tamil, Telugu, and Sanskrit | [![Colab icon](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/dr-mushtaq/Projects/blob/master/National%20Language%20processing/POS%20Tagging%20for%20Multiple%20Languages.py)|POST|Blog is needed|Saket Pol|2025-04-13|☑|
</details>
</details>
