...
| Project Title / Blog | Description | Notebook | Category | To-Do List | Resource Link | Completed |Difficulty|Technologies
|---|---|---|---|---|---|---|---|---|
| [**🌐1 - Stock Price Prediction using Linear Regression**](https://medium.com/@Coursesteach/stock-price-prediction-using-linear-regression-4839bc1240f0) | Accuracy = 0.99, Model = Linear Regression; Techniques: Scikit-learn, Label Encoding, MICE (Multiple Imputation) | [![Colab](https://colab.research.google.com/assets/colab-badge.svg)](https://github.com/hussain0048/Projects-/blob/master/Stock_Price_Prediction.ipynb) | Regression | 🔄 Try other models (XGBoost, SVR), add visualization, deploy using Streamlit | — | ☑ |Beginner|scikit-learn, NLTK, TF-IDF|
| [**🌐2 - Predict Ads Click – Practice Data Analysis**](https://medium.com/@Coursesteach/stock-price-prediction-using-linear-regression-4839bc1240f0) | Classification with Logistic Regression; Techniques: Data Cleaning, Feature Engineering, Label Encoding, MICE | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Projects-/blob/master/Predict_Ads_Click_%E2%80%93_Practice_Data_Analysis_and_Logistic_Regression_Prediction.ipynb) | Classification | 📈 Try different classifiers (Random Forest, XGBoost), improve feature selection | — | ⬜ Pending |Intermediate|
| [**🌐3 - LinkedIn Auto Job Applier with AI**](https://medium.com/@Coursesteach/stock-price-prediction-using-linear-regression-4839bc1240f0) | Automation script using ML for job applications; Techniques: Scikit-learn, Label Encoding, Automation Tools | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Projects/blob/master/linkedIn_auto_jobs_applier_with_AI.ipynb) | Classification / Automation | 🛠 Improve job-matching logic, add real-time application tracking, convert to GUI | — | ⬜ Pending |Advanced|
| [**🌐4 - AI-Powered Restaurant Recommendation Engine**](https://github.com/jarif87/ai-powered-restaurant-recommendation-engine?tab=readme-ov-file) | Automation script using ML for job applications; Techniques: Scikit-learn, Label Encoding, Automation Tools | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=whit)](https://github.com/hussain0048/Projects/blob/master/linkedIn_auto_jobs_applier_with_AI.ipynb) | Classification / Automation | 🛠 Improve job-matching logic, add real-time application tracking, convert to GUI | — | ⬜ Pending |
| [**🌐5 -How to build production-ready ML Systems**](htt) | Automation script using ML for job applications; Techniques: Scikit-learn, Label Encoding, Automation Tools | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=whit)](https://github.com/hussain0048/Projects/blob/master/linkedIn_auto_jobs_applier_with_AI.ipynb) | Classification / Automation | 🛠 Improve job-matching logic, add real-time application tracking, convert to GUI | — | ⬜ Pending |
...
| 🌐 8 - Image-to-Image Search System | Visual search using embeddings (DEMO) | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Projects-/blob/master/Age%2C_Gender_and_Race_Prediction.ipynb) | Classification | Real-time not working in Colab, try advanced DL techniques | Dr. Mushtaq | 2024-06-02 | ⏳ Pending | [ChatGPT Demo](https://chatgpt.com/share/68732cf4-df58-800c-a873-94ad001730d9), [-GitHub Repo](https://github.com/matsui528/sis),[-3](https://cocoindex.io/blogs/colpali),[-4](https://github.com/cocoindex-io/cocoindex) |
| 🌐 8 - Image Classification with CLIP | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Projects-/blob/master/Age%2C_Gender_and_Race_Prediction.ipynb) | Classification | Real-time not working in Colab, try advanced DL techniques | Dr. Mushtaq | 2024-06-02 | ⏳ Pending | [blog](https://visionbrick.com/image-classification-with-clip-image-text-similarity-and-zero-shot-labels/) |
...
|---|---|---|---|---|---|---|---|---|
| [**🌐1 - Spam Detection using Machine Learning Methods**](https://medium.com/@Coursesteach/spam-detection-using-machine-learning-methods-dd5dbc799b6b) | Naive Bayes = 95–97%, SVM = 98–99%, using CountVectorizer, Scikit-learn, Grid Search CV | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Projects-/blob/master/Spam_Detection_using_Machine_Learning.ipynb) | Text Classification | Try other models, enhance preprocessing | Dr. Mushtaq | 2024-04-12 | ☑ |
| [**🌐2 - Hate Speech Detection**](https://medium.com/@Coursesteach/hate-speech-detection-with-machine-learning-c7d12a217e69) | Decision Tree = 75%, CountVectorizer, Scikit-learn | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Projects-/blob/master/Hate_Speech_Detection_with_Machine_Learning(_Decsion_Tree)_(1).ipynb) | Text Classification | Test with different classifiers and preprocessing | Dr. Mushtaq | 2024-04-21 | ☑ |
| [**🌐3 - Detecting Sports Content**](https://medium.com/@Coursesteach/detecting-sports-content-with-machine-learning-ec9c3138166e) | SVM = 66%, CountVectorizer, Scikit-learn | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Projects-/blob/master/Detecting_Sports_Content_with_Machine_Learning%22.ipynb) | Text Classification | Try new models and advanced preprocessing | Dr. Mushtaq | 2024-04-28 | ☑ |
| [**🌐4 - Personality Prediction Through CV**](https://github.com/HiteshAgarwal1/Personality-Prediction-Through-CV/tree/master) | SVM = 66%, CountVectorizer, Scikit-learn | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Projects-/blob/master/Detecting_Sports_Content_with_Machine_Learning%22.ipynb) | Text Classification | Try other models, preprocessing methods | Dr. Mushtaq | 2024-04-28 | ⬜ Pending |
| [**🌐5 - Predicting Movie Reviews with ML**](https://medium.com/@Coursesteach/using-machine-learning-to-predict-movie-reviews-82b0ab1db313) | Gaussian = 0.78, Multinomial = 0.83, Bernoulli = 0.84 | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Projects-/blob/master/Movie_Reviews_through_Sentiment_Analysis_in_NLP.ipynb) | Sentiment Analysis | Explore more ML & DL models | Dr. Mushtaq | 2024-05-05 | ☑ |
| [**🌐6 - Text Preprocessing 101**](https://medium.com/@Coursesteach/tokenization-stemming-lemmatization-stopword-and-pos-tagging-in-python-31b945b3c233) | Covers tokenization, stemming, lemmatization, stopword removal, POS tagging | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Projects-/blob/master/Tokenization_stemming_lemmatization_stopword_postagging.ipynb) | Preprocessing | -- | Dr. Mushtaq | 2024-05-26 |⭐️ (Easy)| ☑ |
| [**🌐7 - Important Python Scripts for NLP**](https://medium.com/@Coursesteach/tokenization-stemming-lemmatization-stopword-and-pos-tagging-in-python-31b945b3c233) | Utility scripts (Text-to-Speech etc.) | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Projects-/blob/master/Important_Python_script.ipynb) | Script | -- | Dr. Mushtaq | 2024-05-26 | 🔄 In Process |
| [**🌐8 - Stress Detection using ML**](https://medium.com/@Coursesteach/tokenization-stemming-lemmatization-stopword-and-pos-tagging-in-python-31b945b3c233) | Detecting stress levels via text data | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Projects-/blob/master/Stress_Detection_with_Machine_Learning.ipynb) | Script | -- | Dr. Mushtaq | 2024-05-26 | ⬜ Pending |
| [**🌐9 - Next Word Prediction**](https://medium.com/@Coursesteach/tokenization-stemming-lemmatization-stopword-and-pos-tagging-in-python-31b945b3c233) | Predict the next word in a sequence | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Projects-/blob/master/Next_Word_Prediction_Model.ipynb) | Script | -- | Dr. Mushtaq | 2024-05-26 | ⬜ Pending 🔄 |
| [**🌐10 - Emotion Detection in Text**](https://medium.com/@Coursesteach/emotion-detection-in-text-5b8d05db655f) | Compare TF-IDF & CountVectorizer with NB, SVM, LR, RF | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Projects/blob/master/Emotion_Detection_in_Text.ipynb) | Sentiment Analysis | -- | Dr. Mushtaq | 2024-09-16 | ☑ |
| [**🌐11 - Auto Apply for Jobs with AI**](https://medium.com/@Coursesteach/tokenization-stemming-lemmatization-stopword-and-pos-tagging-in-python-31b945b3c233) | Automates job applications | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Projects/blob/master/Auto_Apply_for_Job_with_AI.ipynb) | Script | -- | Dr. Mushtaq | 2024-05-26 | ⬜ Pending |
| [**🌐12 - Chatbot for Healthcare**](https://medium.com/@Coursesteach/tokenization-stemming-lemmatization-stopword-and-pos-tagging-in-python-31b945b3c233) | NLP-based chatbot for healthcare support | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/hussain0048/Projects/blob/master/chatbot_in_Healthcare.ipynb) | Script | -- | Dr. Mushtaq | 2024-05-26 | ⭐⭐⭐ (Hard)|⬜ Pending |
| [**🌐13 - File Organizer Script**](https://medium.com/@Coursesteach/tokenization-stemming-lemmatization-stopword-and-pos-tagging-in-python-31b945b3c233) | Script to organize files into folders | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/dr-mushtaq/Projects/blob/master/File_organizer.ipynb) | Script | -- | Dr. Mushtaq | 2024-05-26 | ⬜ Pending |
| [**🌐14 - Plagiarism Checker**](https://medium.com/@Coursesteach/tokenization-stemming-lemmatization-stopword-and-pos-tagging-in-python-31b945b3c233) | NLP script to check for plagiarism | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/dr-mushtaq/Projects/blob/master/Plagiarism_checker_Python.ipynb) | Script | -- | Dr. Mushtaq | 2024-05-26 | ⬜ Pending |
| [**🌐15 - Multilingual POS Tagging App**](https://mushtaqmsit.substack.com/p/building-a-multilingual-pos-tagging) | FastAPI app using Stanford's Stanza for multilingual POS tagging (English, Hindi, Marathi, Tamil, etc.) | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/dr-mushtaq/Projects/blob/master/National%20Language%20processing/POS%20Tagging%20for%20Multiple%20Languages.py) | POST | 📝 Check blog | Saket Pol | 2025-04-13 |⭐⭐ (Medium)| ☑ |
| [**🌐16 - Fitness Assistant**](https://github.com/alexeygrigorev/fitness-assistant) | FastAPI app using Stanford's Stanza for multilingual POS tagging (English, Hindi, Marathi, Tamil, etc.) | [![Colab](https://img.shields.io/badge/Colab-Open-blue.svg?logo=colab&logoColor=white)](https://github.com/dr-mushtaq/Projects/blob/master/National%20Language%20processing/POS%20Tagging%20for%20Multiple%20Languages.py) | POST | 📝 Check blog | Saket Pol | 2025-04-13 |⭐⭐ (Medium)| Pending |
</details>
...
| 🧠 Stage | 🔍 Key Topics | ⚙️ Tools & Libraries | 📌 Sample Projects / Ideas |
|----------|---------------|------------------------|-----------------------------|
| 🔰 **Foundations** | - Types of ML (Supervised, Unsupervised, RL)<br>- Data Preprocessing<br>- Feature Engineering<br>- Train/Test Split | NumPy, Pandas, Matplotlib, Scikit-learn | - Housing Price Prediction<br>- Titanic Survival Prediction<br>- Basic Classification with Sklearn |
| 📊 **Exploratory Data Analysis (EDA)** | - Data Cleaning<br>- Outlier Detection<br>- Visualization<br>- Correlation Analysis | Seaborn, Pandas Profiling, Matplotlib | - Student Score Prediction<br>- Heart Disease Dataset Analysis<br>- Iris Dataset Insights |
| 🔍 **Supervised Learning** | - Linear & Logistic Regression<br>- KNN<br>- Decision Trees, Random Forest<br>- SVM, Naive Bayes | Scikit-learn, XGBoost, LightGBM | - Spam Email Detection<br>- Loan Approval Prediction<br>- Customer Churn Model |
| 🧠 **Unsupervised Learning** | - K-Means Clustering<br>- Hierarchical Clustering<br>- PCA, t-SNE<br>- Anomaly Detection | Scikit-learn, Yellowbrick | - Customer Segmentation<br>- News Topic Grouping<br>- Credit Card Fraud Detection |
| 🔁 **Model Evaluation** | - Confusion Matrix<br>- Precision/Recall/F1<br>- ROC-AUC<br>- Cross Validation | Scikit-learn, Matplotlib | - Classifier Benchmarking<br>- Compare Models on Same Dataset<br>- K-Fold Analysis Report |
...
|[**18-Best Generative AI Projects For Resume by DeepLearning.AI**](https://www.mltut.com/best-generative-ai-projects-for-resume/)|7 free and hands-on Generative AI projects|---|
|[**19-Building a Facebook Chatbot in Chatfuel**](https://www.udemy.com/course/building-a-facebook-messenger-chat-bot-in-chatfuel/?im_ref=zU9VMAStxxycRnFTVA2iK3QzUku1g%3AV000000w0&sharedid=&irpid=6778825&utm_medium=affiliate&utm_source=impact&utm_audience=mx&utm_tactic=%22Content%22%2C%22India%22&utm_content=3193860&utm_campaign=6778825&irgwc=1&afsrc=1)|7 free and hands-on Generative AI projects|---|
